...
# Unit tests for OpenapiClient::BodaccAchatAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BodaccAchatAllOf do
  let(:instance) { OpenapiClient::BodaccAchatAllOf.new }

  describe 'test an instance of BodaccAchatAllOf' do
    it 'should create an instance of BodaccAchatAllOf' do
      expect(instance).to be_instance_of(OpenapiClient::BodaccAchatAllOf)
    end
  end
