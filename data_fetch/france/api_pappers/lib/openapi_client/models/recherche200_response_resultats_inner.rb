...
module OpenapiClient
  class Recherche200ResponseResultatsInner
    ...
    def self.attribute_map
      {
        ...
        :'nb_dirigeants_total' => :'nb_dirigeants_total',
        :'nb_beneficiaires_total' => :'nb_beneficiaires_total',
        :'nb_documents_avec_mentions' => :'nb_documents_avec_mentions',
        :'nb_documents_total' => :'nb_documents_total',
        :'nb_publications_avec_mentions' => :'nb_publications_avec_mentions',
        :'nb_publications_total' => :'nb_publications_total'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'nb_dirigeants_total' => :'Integer',
        :'nb_beneficiaires_total' => :'Integer',
        :'nb_documents_avec_mentions' => :'Integer',
        :'nb_documents_total' => :'Integer',
        :'nb_publications_avec_mentions' => :'Integer',
        :'nb_publications_total' => :'Integer'
      }
    end
    ...
    def self.openapi_all_of
      [
      :'EntrepriseRecherche',
      :'Recherche200ResponseResultatsInnerAllOf'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::Recherche200ResponseResultatsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Recherche200ResponseResultatsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dirigeants')
        if (value = attributes[:'dirigeants']).is_a?(Array)
          self.dirigeants = value
        end
      end

      if attributes.key?(:'beneficiaires')
        if (value = attributes[:'beneficiaires']).is_a?(Array)
          self.beneficiaires = value
        end
      end
      ...
      if attributes.key?(:'nb_dirigeants_total')
        self.nb_dirigeants_total = attributes[:'nb_dirigeants_total']
      end

      if attributes.key?(:'nb_beneficiaires_total')
        self.nb_beneficiaires_total = attributes[:'nb_beneficiaires_total']
      end

      if attributes.key?(:'nb_documents_avec_mentions')
        self.nb_documents_avec_mentions = attributes[:'nb_documents_avec_mentions']
      end

      if attributes.key?(:'nb_documents_total')
        self.nb_documents_total = attributes[:'nb_documents_total']
      end

      if attributes.key?(:'nb_publications_avec_mentions')
        self.nb_publications_avec_mentions = attributes[:'nb_publications_avec_mentions']
      end

      if attributes.key?(:'nb_publications_total')
        self.nb_publications_total = attributes[:'nb_publications_total']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dirigeants == o.dirigeants &&
          beneficiaires == o.beneficiaires &&
          documents == o.documents &&
          publications == o.publications &&
          nb_dirigeants_total == o.nb_dirigeants_total &&
          nb_beneficiaires_total == o.nb_beneficiaires_total &&
          nb_documents_avec_mentions == o.nb_documents_avec_mentions &&
          nb_documents_total == o.nb_documents_total &&
          nb_publications_avec_mentions == o.nb_publications_avec_mentions &&
          nb_publications_total == o.nb_publications_total
    end
