  ...
  class AssociationAdresseGestionnaire
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AssociationAdresseGestionnaire` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AssociationAdresseGestionnaire`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'gestionnaire')
        self.gestionnaire = attributes[:'gestionnaire']
      end
      ...
      if attributes.key?(:'adresse_ligne')
        self.adresse_ligne = attributes[:'adresse_ligne']
      end
      ...
      if attributes.key?(:'indication')
        self.indication = attributes[:'indication']
      end
    ...
    def hash
      [gestionnaire, code_postal, ville, distribution, adresse_ligne, complement_adresse, indication, pays].hash
    end
