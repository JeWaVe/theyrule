...
module OpenapiClient
  class RechercheBeneficiaires200ResponseResultatsInner
    ...
    attr_accessor :nb_entreprises_total
    ...
    attr_accessor :entreprises_dirigeant

    # Nombre d'entreprises dont le bénéficiaire effectif est dirigeant au total.
    attr_accessor :nb_entreprises_dirigeant_total
    ...
    def self.attribute_map
      {
        ...
        :'entreprises_dirigeant' => :'entreprises_dirigeant',
        :'nb_entreprises_dirigeant_total' => :'nb_entreprises_dirigeant_total'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'nb_entreprises_total' => :'Integer',
        :'entreprises_dirigeant' => :'Array<EntrepriseRecherche>',
        :'nb_entreprises_dirigeant_total' => :'Integer'
      }
    end
    ...
    def self.openapi_all_of
      [
      :'Beneficiaire',
      :'RechercheBeneficiaires200ResponseResultatsInnerAllOf'
      ]
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RechercheBeneficiaires200ResponseResultatsInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RechercheBeneficiaires200ResponseResultatsInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'entreprises')
        if (value = attributes[:'entreprises']).is_a?(Array)
          self.entreprises = value
        end
      end

      if attributes.key?(:'nb_entreprises_total')
        self.nb_entreprises_total = attributes[:'nb_entreprises_total']
      end

      if attributes.key?(:'entreprises_dirigeant')
        if (value = attributes[:'entreprises_dirigeant']).is_a?(Array)
          self.entreprises_dirigeant = value
        end
      end

      if attributes.key?(:'nb_entreprises_dirigeant_total')
        self.nb_entreprises_dirigeant_total = attributes[:'nb_entreprises_dirigeant_total']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          nb_entreprises_total == o.nb_entreprises_total &&
          entreprises_dirigeant == o.entreprises_dirigeant &&
          nb_entreprises_dirigeant_total == o.nb_entreprises_dirigeant_total
    end
